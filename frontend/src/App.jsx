    ...
    <div className="App">
      ...
      <div>
        ...
        <div className="terminal">
          <div className="line">$ curl -H "localtonet-skip-warning: 1" "https://eswzb3ycjm.localto.net/name/jaylen/brown"</div>
        </div>

        <p>Or you can just go to <a href="https://eswzb3ycjm.localto.net/name/jaylen/brown" target="_blank" rel="noopener noreferrer">https://eswzb3ycjm.localto.net/name/jaylen/brown</a> to view the response in your browser.</p>
